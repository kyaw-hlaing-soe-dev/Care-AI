      ...
      <Reveal>
        <div className="rounded-[28px] border border-white/90 bg-white/72 p-6 shadow-[0_22px_60px_-38px_rgba(35,79,137,0.34)] backdrop-blur-lg sm:p-8 lg:flex lg:items-center lg:gap-10">
          <div className="max-w-sm text-center lg:text-left">
            <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-blue-600">Privacy &amp; trust</p>
            <h2 className="mt-3 text-3xl font-extrabold tracking-[-0.04em] text-slate-950 sm:text-4xl">Your health data stays yours.</h2>
          </div>
          ...
          <ul className="mt-7 grid flex-1 gap-5 sm:grid-cols-3 lg:mt-0">
            {TRUST_ITEMS.map(({ Icon, title, body }) => (
              <li key={title} className="text-center sm:text-left">
                <span className="mx-auto grid size-10 place-items-center rounded-[14px] bg-blue-50 text-blue-600 sm:mx-0"><Icon className="size-4.5" /></span>
