        ...
        <Reveal>
          <div className="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
            ...
            <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
              CareAI converts your latest readings into understandable observations, so you can
              quickly see what looks typical and what may be worth monitoring.
            </p>
            ...
            <p className="mt-6 text-xs leading-5 text-slate-500">
              Informational insights only—not a diagnosis or replacement for professional medical
              advice.
            </p>
          </div>
        </Reveal>
