const en = {
  ...
  validation: {
    ...
    systolic: "Enter a systolic value between 50 and 300 mmHg.",
    diastolic: "Enter a diastolic value between 30 and 200 mmHg.",
    heartRate: "Enter a heart rate between 20 and 250 bpm.",
    oxygen: "Enter an oxygen saturation between 50% and 100%.",
    temperature: "Enter a temperature between 30°C and 45°C.",
  },
  auth: {
    visualBadge: "Private health companion",
    visualTitle: "Your health,",
    visualTitleAccent: "understood.",
    visualBody:
      "Track your vitals and review clear range-based insights that help you understand changes over time.",
    ...
    phoneBody: "Enter your phone number and we'll send you a verification code.",
    country: "Country",
    ...
    phoneErrors: {
      ...
      tooMany: "Too many attempts. Please wait and try again later.",
    ...
    aiHealthScore: "Deterministic health score",
    normal: "Normal",
    excellent: "Excellent",
    great: "Great",
  ...
  vitals: {
    ...
    title: "Vital Tracker",
    subtitle: "Validate and save your latest readings.",
    ...
    save: "Save My Vitals",
    saving: "Saving your vitals…",
    saved: "Reading saved.",
    saveFailed: "We couldn't save your vitals. Please try again.",
  ...
  profile: {
    ...
    aiDisclaimer: "Health Insight Disclaimer",
    ...
    signOutBody: "You can sign back in with a connected account.",
  ...
  landing: {
    ...
    hero: {
      badge: "Your Private Health Companion",
      title: "Understand Your Health.",
      titleAccent: "One Reading at a Time.",
      body: "Track your vital signs, understand your trends, and receive clear range-based health insights — all in one place.",
    ...
    features: {
      ...
      insights: "Range-Based Health Insights",
    ...
    preview: {
      ...
      subtitle:
        "See your latest readings, health score, structured insights and trends without digging through complicated health data.",
      demo: "Demo",
    ...
    trust: {
      ...
      responsible: "Cautious insights",
      responsibleBody:
        "CareAI uses documented reference ranges and does not provide a medical diagnosis.",
    },
    cta: {
    ...
    footer: {
      body: "Simple vital tracking and deterministic health insights.",
      privacy: "Privacy",
      about: "About",
      contact: "Contact",
      copyright:
