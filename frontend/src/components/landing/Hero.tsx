...
const WIDGETS = [
  {
    ...
    pos: "left-[1%] top-[0%] sm:left-[16%] sm:top-[10%] lg:left-[1%] lg:top-[23%]",
    show: "flex",
    delay: 0,
    rotate: -7,
  },
  {
    ...
    pos: "left-[1%] bottom-[6%] sm:left-[4%] sm:bottom-[16%] md:left-auto md:right-[1%] md:top-[28%] md:bottom-auto lg:top-[13%]",
    show: "flex",
    delay: 0.8,
    rotate: 6,
  },
  ...
  },
  {
    ...
    pos: "right-[1%] bottom-[6%] sm:right-[3%] sm:bottom-[16%] lg:right-[0%] lg:bottom-[34%]",
    show: "flex",
    delay: 0.4,
    rotate: -5,
  },
