...
## Server validation — IMPLEMENTED IN CODE, NOT DEPLOYED
...
The Cloud Functions endpoint verifies the Firebase ID token, then repeats strict-key, numeric, finite-number, and technical range validation before scoring, writing, or calling OpenRouter.
