...
- Authentication -> Settings -> Authorized domains must include every served CareAI domain, including `care-ai-4eb8d.firebaseapp.com`, localhost domains used for development, and the deployed Vercel domain when used, such as `vitals-glass.vercel.app`.
