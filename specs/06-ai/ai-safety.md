...
**CARE-AI-004 — P0 / IMPLEMENTED IN CODE, CLINICAL REVIEW PENDING:** Every insight view includes: “CareAI provides informational health insights and is not a substitute for professional medical advice.” Deterministic emergency copy still requires clinical-policy review before production. Optional OpenRouter output may be displayed only after the protected server route normalizes it, rejects unsafe medical language, and preserves deterministic score/status/emergency/urgency.
